                ...
                <Row gutter={[20, 20]}>
                            ...
                            return (
                                <div className='order-book' key={`book-${index}`}>
                                    <div className='book-content'>
                                        <div className='left'>
                                            {/* <Checkbox onChange={(e) => handleCheckboxChange(e, book._id)}></Checkbox> */}
                                    ...
                                    <div className='action'>
                                        ...
                                        <div>
                                            <span className='sum'>
                                                {new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(book?.detail?.price * book?.quantity)}</span>
                                        </div>
                    ...
                    <Col md={6} xs={24} >
                        <div className='order-sum'>
                            ...
                            <div className="input-vouncher" style={{ width: '100%', height: '60px', color: '1px solid orange' }}>
                                <input type="text" placeholder='Discount code' style={{ width: '70%', height: '50px', borderRadius: '5px', paddingLeft: '10px', outline: 'none', marginRight: '2%' }} />
                                <button style={{ width: '28%', height: '50px' }}>Apply</button>
                            </div>
                           
                          <button
                             onClick={submit}>Mua Hàng {`(${checkedItems.length})`}    
                          </button>
                        </div>
                    </Col>
                </Row>
